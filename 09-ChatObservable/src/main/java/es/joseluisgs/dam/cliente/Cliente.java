...
public class Cliente extends JFrame {
    ...
    public Cliente(){
        ...
        // Colocacion de los componentes en la ventana, lo hago a pelo sin usar NetBeans
        ...
        this.setTitle("Cliente chat: "+ this.usuario);
        ...
        btEnviar.addActionListener(new AccionEnviar(socket, tfMensaje, usuario));
    ...
    public void recibirMensajesServidor(){
        ...
        GestionMensajes gm = new GestionMensajes( entradaDatos, mensajesChat);
        gm.start();
    ...
    public static void main(String[] args) {
        // Cargamos el cliente y le decimos que reciba      
